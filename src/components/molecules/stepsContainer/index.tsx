...
export const StepsContainer = () => {
  ...
  return (
    <section className="p-4 py-6 bg-white min-w-fit flex flex-row justify-start items-start rounded-[20px] col-span-12 ">
      <div className="flex flex-row gap-12 relative items-start w-full">
